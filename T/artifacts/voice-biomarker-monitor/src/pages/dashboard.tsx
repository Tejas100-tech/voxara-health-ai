  ...
  return (
    <AppLayout userType="patient">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Hero Banner */}
        <section className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#011C40] via-[#023859] to-[#011C40] text-white p-8 md:p-10 flex flex-col xl:flex-row items-stretch justify-between gap-8 shadow-2xl shadow-[#54ACBF]/15">
          ...
          <div className="relative z-10 space-y-5 max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 backdrop-blur-md rounded-full text-xs font-bold tracking-wider uppercase text-cyan-200 border border-white/10">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold font-[Manrope] leading-tight">
              {t("landing.heroTitle")}{" "}
              <span className="text-cyan-200">{t("landing.heroHighlight")}</span>
            </h2>
            <p className="text-cyan-100/75 text-base leading-relaxed">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center gap-4 min-w-[240px]">
            <Link href="/intake">
              <button className="group relative flex flex-col items-center justify-center w-48 h-48 rounded-full luna-btn-teal transition-all duration-500 shadow-2xl shadow-[#54ACBF]/25 active:scale-95 hover:scale-105 glow-pulse">
                <span className="absolute inset-[-16px] rounded-full border border-cyan-200/20 animate-pulse" />
            ...
            <p className="text-xs font-bold uppercase tracking-widest text-cyan-200/60">5 steps · ~5 minutes</p>
          </div>
        </section>
        ...
        <section className="grid md:grid-cols-3 gap-4">
          ...
          <Link href="/profile">
            <div className="bg-card border rounded-[2rem] p-7 card-hover cursor-pointer">
              <ShieldCheck size={28} className="text-[#26658C] dark:text-cyan-300 mb-4" />
