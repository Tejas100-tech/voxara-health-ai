  ...
  return (
    <AppLayout userType="patient">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Hero Banner */}
        <section className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-slate-950 via-emerald-950 to-slate-950 text-white p-8 md:p-10 flex flex-col xl:flex-row items-stretch justify-between gap-8 shadow-2xl shadow-emerald-500/10">
          ...
          <div className="relative z-10 space-y-5 max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 backdrop-blur-md rounded-full text-xs font-bold tracking-wider uppercase text-emerald-300 border border-white/10">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center gap-4 min-w-[240px]">
            <Link href="/intake">
              <button className="group relative flex flex-col items-center justify-center w-48 h-48 rounded-full bg-gradient-to-br from-emerald-500 to-teal-400 transition-all duration-500 shadow-2xl shadow-emerald-500/20 active:scale-95 hover:scale-105 glow-pulse">
                <span className="absolute inset-[-16px] rounded-full border border-emerald-300/15 animate-pulse" />
        ...
        <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: t("records.intakes"), value: "3", icon: ClipboardList, color: "text-emerald-600" },
            { label: t("documents.scanned"), value: "7", icon: ScanLine, color: "text-teal-600" },
            { label: t("records.summaries"), value: "2", icon: FileText, color: "text-blue-600" },
            { label: t("records.reviewed"), value: "1", icon: Clock, color: "text-emerald-600" },
        ...
        <section className="grid md:grid-cols-3 gap-4">
          <Link href="/intake">
            <div className="bg-gradient-to-br from-emerald-500 to-teal-400 rounded-[2rem] p-7 text-white shadow-xl card-hover cursor-pointer">
          ...
          <Link href="/records">
            <div className="bg-card border rounded-[2rem] p-7 card-hover cursor-pointer">
              <ScanLine size={28} className="text-teal-600 dark:text-teal-400 mb-4" />
          ...
          <Link href="/profile">
            <div className="bg-card border rounded-[2rem] p-7 card-hover cursor-pointer">
              <ShieldCheck size={28} className="text-emerald-600 dark:text-emerald-400 mb-4" />
